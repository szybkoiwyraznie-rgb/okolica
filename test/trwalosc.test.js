 ...
 * klucze, budżet, STRAŻNIK plaintextu — zapis nie może zawierać treści pytań.
 *
 * Historii gier na telefonie NIE MA (zgłoszenie terenowe O, 2026-09-13;
 * ADR 0010 aneks) — razem z nią zniknęły skróty `historia-gra/1`, kody H01–H04
 * i ich testy. Wynik gry jedzie na wspólny Drive, a powrót do przerwanej gry
 * daje wyłącznie ten zapis (snapshot `stan-gry/1`).
 */
