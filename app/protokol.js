...
import { TEMATY, WIEK, TRYBY, kanonicznyTemat, liczbaPytan } from './konfig.js?v=m12-105';
import { czyWspolrzedneOk, formatujWspolrzedne, odlegloscM } from './geo.js?v=m12-105';
...
export const SZABLON_WERSJA = 'PYT/1.0.8'; // 1.0.8: bez zdania „niczego nie odwracaj ani nie szyfruj” (uwagi terenowe G.b, 2026-09-12)

/** Wersja szablonu bez weryfikacji (§2.2) — wersjonowana niezależnie od §2. */
export const SZABLON_WERSJA_BEZ_WERYFIKACJI = 'PYT/1.0-nofc.3'; // .3: jak 1.0.8 — bez zdania „nie odwracaj, nie szyfruj” (G.b, 2026-09-12)
...
export { SCHEMAT_KONTENERA, KODOWANIE } from './kodowanie.js?v=m12-105';
