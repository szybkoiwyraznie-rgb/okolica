...
import { TEMATY, WIEK, TRYBY, kanonicznyTemat, liczbaPytan } from './konfig.js?v=m12-131';
import { czyWspolrzedneOk, formatujWspolrzedne, odlegloscM } from './geo.js?v=m12-131';
...
export const SZABLON_WERSJA = 'PYT/1.0.9'; // 1.0.9: poprawna = czysty indeks 0–3 (ADR 0049)

/** Wersja szablonu bez weryfikacji (§2.2) — wersjonowana niezależnie od §2. */
export const SZABLON_WERSJA_BEZ_WERYFIKACJI = 'PYT/1.0-nofc.4'; // .4: jak 1.0.9 — poprawna bez kodowania (ADR 0049)
...
export { SCHEMAT_KONTENERA, KODOWANIE } from './kodowanie.js?v=m12-131';
