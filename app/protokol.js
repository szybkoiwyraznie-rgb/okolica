...
import { TEMATY, WIEK, TRYBY, kanonicznyTemat, liczbaPytan } from './konfig.js?v=m12-142';
import { czyWspolrzedneOk, formatujWspolrzedne, odlegloscM } from './geo.js?v=m12-142';
...
export const SZABLON_WERSJA = 'PYT/1.1.1'; // 1.1.1: trzy zdania po uwagach właściciela 2026-09-15f (kotwica bez przepisu o nazwie miejsca, zasada 7 wprost, równa liczba pytań na stację)

/** Wersja szablonu bez weryfikacji (§2.2) — wersjonowana niezależnie od §2. */
export const SZABLON_WERSJA_BEZ_WERYFIKACJI = 'PYT/1.1-nofc.1'; // jak 1.1.1 — te same trzy zdania w wariancie bez weryfikacji
