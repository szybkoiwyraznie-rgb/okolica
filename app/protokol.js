...
import { TEMATY, WIEK, TRYBY, kanonicznyTemat, liczbaPytan } from './konfig.js?v=m12-8';
import { czyWspolrzedneOk, formatujWspolrzedne, odlegloscM } from './geo.js?v=m12-8';
...
export { SCHEMAT_KONTENERA, KODOWANIE } from './kodowanie.js?v=m12-8';
