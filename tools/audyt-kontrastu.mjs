...
export const PARY = Object.freeze([
  ...
  { tekst: 'zloto', tlo: 'tlo-karta', prog: 4.5, opis: 'znaczek fact-check na karcie (ADR 0032)' },
  { tekst: 'zloto', tlo: 'tlo', prog: 4.5, opis: 'znaczek fact-check na tle strony (ADR 0032)' },
