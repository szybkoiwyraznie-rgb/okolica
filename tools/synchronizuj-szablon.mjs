...
const SZABLONY = [
  {
    ...
    sekcja: '§2',
    wymagane: ['{LAT}', '{LON}', '{LISTA_STACJI}', '{GRACZE_BLOK}', 'ZASADY TWARDE', 'numer poprawnej odpowiedzi od 1 do 4', 'POZIOMY PYTAŃ'],
  },
  {
    ...
    sekcja: '§2.2',
    wymagane: ['{LAT}', '{LON}', '{LISTA_STACJI}', '{GRACZE_BLOK}', 'ZASADY TWARDE', 'numer poprawnej odpowiedzi od 1 do 4', 'OPCJONALNE', 'POZIOMY PYTAŃ'],
  },
];
