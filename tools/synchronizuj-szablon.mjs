...
const SZABLONY = [
  {
    ...
    sekcja: '§2',
    wymagane: ['{LAT}', '{LON}', '{LISTA_STACJI}', '{OPIS_TRUDNOSCI}', 'ZASADY TWARDE', 'numer poprawnej odpowiedzi'],
  },
  {
    ...
    sekcja: '§2.2',
    wymagane: ['{LAT}', '{LON}', '{LISTA_STACJI}', '{OPIS_TRUDNOSCI}', 'ZASADY TWARDE', 'numer poprawnej odpowiedzi', 'OPCJONALNE'],
  },
];
