...
## Aneks 2026-09-12 jest w archiwum (poza budżetem lektury)

Wiersz wyjaśnień rankingu (`#ranking-status`) jest na końcu warstwy, pod obiema
tabelami — `docs/decisions/archive/aneksy-0039-2026-09-12.md`.
