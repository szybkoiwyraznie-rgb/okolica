...
## Aneksy 2026-09-07 są w archiwum (poza budżetem lektury)

Kotwica szacowana dla starych paczek (B19) oraz komunikat nazywający powód
niedopasowania — `docs/decisions/archive/aneksy-0024-2026-09-07b.md`, poza
budżetem lektury startowej (AGENTS.md §0; LESSONS L62). Drugi z nich został
odwrócony przez ADR 0046 (promień jest kryterium dopasowania paczek) — tam
jest obowiązująca decyzja.
