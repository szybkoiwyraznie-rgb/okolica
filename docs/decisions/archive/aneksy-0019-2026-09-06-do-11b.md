# Aneksy ADR 0019 z 2026-09-06 … 2026-09-11b (treść historyczna)

- Pochodzenie: `docs/decisions/0019-gra-wieloosobowa-multi-device.md`
- Przeniesione: 2026-09-13 (m12-113), gdy budżet lektury startowej pękł
  (AGENTS.md §0; LESSONS L62)
- Charakter: to NIE jest osobny ADR i NIE ma własnego wiersza w rejestrze —
  ...
  część z nich została później uchylona przez aneksy pozostawione w pliku
  macierzystym (m.in. rankingi: usunięte w 2026-09-11b, przywrócone w innej
  formie w 2026-09-12f i przeniesione do ADR 0039).
