...
„⚙ START GRY” w belce (w trakcie gry przycisk jest zgaszony). Jest walidacja konfiguracji, prompt PYT v1.4 w dwóch
...
| `docs/PROTOKOL.md` | protokół PYT v1.4: krótki prompt bez współrzędnych (kotwica = nazwy z Overpassa; ADR 0060), zestawienie pytań pod stacjami, schemat JSON, walidacja |
